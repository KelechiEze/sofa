...
const CONTENT = {
  ...
  desc: "We source only the finest materials from sustainable suppliers worldwide. Each component undergoes rigorous testing to ensure durability and longevity. Experience the difference that meticulous attention to detail makes in every interaction with our products.",
  video: "/avideo.mp4",
  color: "#8B5CF6"
};
